...
const MUSIC_BANKS = {
  ...
  'noi-nhac-hat-nhac-cu': [
    ...
    q('Cô giáo hỏi: "Nhạc cụ nào phát ra âm thanh khi được gõ?" Em trả lời:',
...
const ETHICS_BANKS = {
  ...
  'yeu-lao-dong': [
    ...
    q('Cô giáo hỏi "Tại sao em cần học cách làm việc nhà?" Em trả lời tốt nhất là:',
  ...
  'quyen-tre-em': [
    q('Em và các bạn trong lớp đang thảo luận. Bạn A nói to át hết. Em muốn chia sẻ ý kiến. Em có quyền gì?',
      ...
      ['Không có quyền vì bạn A đang nói', 'Chỉ được nói nếu cô giáo gọi tên', 'Im lặng vì ý kiến của mình ít quan trọng hơn'],
...
const ART_BANKS = {
  'my-thuat': [
    ...
    q('Cô giáo yêu cầu em pha màu đỏ và màu vàng. Kết quả sẽ là màu gì?',
      'Màu cam',
