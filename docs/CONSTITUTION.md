...
Meuw Academy là nền tảng học hè **chủ động, vui vẻ, và đủ khó** cho bé Meuw (Vũ Hoàng Khả Minh, 9→10 tuổi). App không thay thế trường học — nó là **người bạn học thông minh** giúp bé khám phá thế giới qua trò chơi có chiều sâu.
...
2. **KHÔNG bao giờ để học sinh cảm thấy ngu ngốc.** Sai → Meuw động viên, không mắng.
...
### 2.2 — Luật về Nội dung
1. **MỌI bài học phải có ít nhất 1 SVG minh họa hoặc interactive element.**
2. **Nội dung phải kết nối với cuộc sống thực.** Không học thuộc lòng công thức trống rỗng.
3. **Tiếng Việt chính xác.** Tiếng Anh đúng ngữ pháp. Không "Chinglish" hay lỗi chính tả.
4. **Độ khó tăng dần có kiểm soát.** Câu 1 dễ → câu 3 thử thách. Không đột ngột khó.
5. **Câu hỏi phải có ngữ cảnh.** Không hỏi "2+2=?" — phải là "2 con voi và 2 con voi nữa..."

### 2.3 — Luật về Kỹ thuật
1. **Vanilla JS + CSS + HTML.** KHÔNG import thư viện nào nếu không có lý do cực kỳ chính đáng.
...
5. **Responsive:** Laptop 13–15" là primary, iPad là secondary, mobile là tertiary.

### 2.4 — Luật về Mascot Meuw
1. **Meuw phải xuất hiện ở MỌI interaction quan trọng.** Không có màn hình "câm".
2. **Meuw không bao giờ nổi giận hoặc thất vọng về học sinh.** Chỉ ngạc nhiên và khuyến khích.
3. **Meuw có tính cách:** Hài hước, đôi khi drama, luôn ở phe học sinh.
4. **Meuw nói ngôn ngữ của bé:** Tiếng Việt tự nhiên, emoji, câu ngắn.
...
- Streak break nếu không học hôm đó (nhưng Meuw không blame — chỉ nhắc nhở nhẹ)
...
|---|---|---|
| Trả lời đúng | Confetti + Meuw nhảy | Vui mừng, tự hào |
| Trả lời sai | Shake nhẹ + Meuw lắc đầu | Không sao, thử lại |
| Hoàn thành module | Stars burst + Meuw xoay | Thành tích lớn |
| Load bài mới | Meuw thinking | Hệ thống đang chuẩn bị |
...
### Vercel
- Project name: `meuw-academy`
- Domain: `meuw-academy.vercel.app`
